          ...
          <div className="overflow-x-auto">
            <table className="w-full text-sm table-auto border-4 border-custom-azul">
              <thead className="bg-custom-verde text-white border-b-2 border-custom-azul">
                <tr>
                  <th className="border-r-2 border-custom-azul px-6 py-4 font-bold">
                    Plan
                  </th>
                  <th className="border-r-2 border-custom-azul px-4 py-4 font-bold">
                    Precio / Año
                  </th>
                  <th className="border-r-2 border-custom-azul px-4 py-4 font-bold">
                    Beneficios
              ...
              <tbody className="text-xs text-center">
                <tr className="bg-custom-blanco border-b-2 border-custom-azul">
                  <td className="border-r-2 border-custom-azul px-4 py-6">
                    Básico
                  </td>
                  <td className="border-r-2 border-custom-azul px-4 py-6">
                    60€
                  ...
                  <td className="border-r-2 border-custom-azul px-4 py-6">
                    Soporte estándar, almacenamiento limitado y alguna
                    funcionalidad extra.
                  </td>
                  <td className="px-4 py-6">
                    Perfecto para negocios pequeños que necesitan control de
                    stock básico.
                  </td>
                </tr>
                <tr className="bg-custom-blanco border-b-2 border-custom-azul">
                  <td className="border-r-2 border-custom-azul px-6 py-6">
                    Profesional
                  </td>
                  <td className="border-r-2 border-custom-azul px-4 py-6">
                    600€
                  ...
                  <td className="border-r-2 border-custom-azul px-4 py-6">
                    Almacenamiento ilimitado, actualizaciones completas, soporte
                    prioritario y mejora de IA.
                  </td>
                ...
                <tr className="bg-custom-blanco">
                  ...
                  <td className="border-r-2 border-custom-azul px-4 py-6">
                    Desarrollo a medida, Soporte premium, Asistencia 24/7.
                  </td>
                  <td className="px-4 py-6">
                    Grandes empresas con necesidades específicas.
                  </td>
                </tr>
              </tbody>
            </table>
